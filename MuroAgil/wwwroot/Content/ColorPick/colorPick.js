...
(function( $ ) {
    ...
    $.colorPick.prototype = {
        ...
        show: function(left, top) {
            ...
            $(".colorPickSelector").parent().append('<div id="colorPick" style="display:none; position: absolute; top:' + ($(".colorPickSelector").position().top + $(".colorPickSelector").outerHeight() / 2) + 'px;left:' + ($(".colorPickSelector").position().left + $(".colorPickSelector").outerWidth() / 2) + 'px"><span>' + $.fn.colorPick.defaults.paletteLabel + '</span></div>');
